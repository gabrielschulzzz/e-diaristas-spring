...
public class ServicoController {
    ...
    public String editar(@PathVariable Long id, @Valid @ModelAttribute("form") ServicoForm form, BindingResult result,
        ...
        attrs.addFlashAttribute("alert", new FlashMessage("alert-warning", "Serviço editado com sucesso!"));
    ...
    public String excluir(@PathVariable Long id, RedirectAttributes attrs) {
        ...
        attrs.addFlashAttribute("alert", new FlashMessage("alert-danger", "Serviço removido com sucesso!"));
